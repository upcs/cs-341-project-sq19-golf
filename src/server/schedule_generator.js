...
module.exports = {
  generateSchedules: (courseIDs, subjects, classes) => {
    try {
	  ...
	  filteredSchedules = filterSchedules(possibleSchedules);
	  let arraySchedules = new Array(filteredSchedules.length);
	  ...
	  for (var i = 0; i < filteredSchedules.length; i++){
		  arraySchedules[i] = new Schedule(filteredSchedules[i], freeHours);
	  }
